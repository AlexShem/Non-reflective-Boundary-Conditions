function [lam_ser_1, lam_ser_2, lam_ser_3, lam_ser_4, sqrt_series_13, sqrt_series_24] = ...
    lambda_series_num_newLam(nu, mu, N_lam)
    ...
    sqrt_series_13 = sqrt(.25 * theta_13^2 - 1) * conv(sum_plus , sum_minus);
    lam_ser_1 = polysum(eta_1/2 , -sqrt_series_13);
    lam_ser_1 = lam_ser_1(end-N_lam:end);
    lam_ser_3 = polysum(eta_1/2 , sqrt_series_13);
    ...
    sqrt_series_24 = sqrt(.25 * theta_24^2 - 1) * conv(sum_plus , sum_minus);
    lam_ser_2 = polysum(eta_2/2 , -sqrt_series_24);
    lam_ser_2 = lam_ser_2(end-N_lam:end);
    lam_ser_4 = polysum(eta_2/2 , sqrt_series_24);
